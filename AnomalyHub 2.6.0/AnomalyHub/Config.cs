...
namespace AnomalyHub
{
    public class Config : IConfig
    {
        ...
        [Description("Player enter broadcast can show everyone else?")]
        public bool EnterBroadcastShow { get; set; } = false;
        ...
        [Description("Auto Broadcast Message")]
        public string AutoBroadcastME { get; set; } = "join our discord server! discord.gg/discord";

        [Description("Auto Broadcast Is Enabled?")]
        public bool AutoBroadcast {  get; set; } = true;

        [Description("Auto Broadcast message resend time(secondes)")]
        ...
        [Description("SCP-106 insta kill")]
        public bool SCP106insta { get; set; } = false;

        [Description("SCP-049 insta kill")]
